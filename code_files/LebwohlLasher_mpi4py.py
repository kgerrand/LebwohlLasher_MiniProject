"""
Accelerated version of basic Python Lebwohl-Lasher code using mpi4py.
...
# importing and initialising MPI
...
#=======================================================================
def MC_step_parallel(arr,Ts,nmax):
    """
    Arguments:
	  arr (float(nmax,nmax)) = array that contains lattice data;
	  Ts (float) = reduced temperature (range 0 to 2);
    ...
    combined_accept = MPI.COMM_WORLD.allreduce(accept, op=MPI.SUM)
    
    acceptance_ratio = combined_accept/(nmax*nmax)
